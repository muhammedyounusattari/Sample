...
import com.sample.sample.application.core.authorization.permission.IPermissionAppService;
...
public class UserspermissionController {
            ...
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        String.format("There does not exist a userspermission with a id=%s", id)
                    )
            );
    ...
    public ResponseEntity<UpdateUserspermissionOutput> update(
        ...
        Optional
            .ofNullable(currentUserspermission)
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
    ...
    public ResponseEntity find(
        ...
        return ResponseEntity.ok(_userspermissionAppService.find(searchCriteria, Pageable));
    }

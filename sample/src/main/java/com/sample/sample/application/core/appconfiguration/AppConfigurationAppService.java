...
import com.sample.sample.domain.core.appconfiguration.IAppConfigurationRepository;
import com.sample.sample.domain.core.appconfiguration.QAppConfigurationEntity;
import java.time.*;
import java.util.*;

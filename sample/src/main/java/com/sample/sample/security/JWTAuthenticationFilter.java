...
import com.sample.sample.domain.core.authorization.jwtentity.IJwtRepository;
import com.sample.sample.domain.core.authorization.jwtentity.JwtEntity;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse res)
        ...
        try {
            ...
            UsersEntity user = _userRepository.findByUsername(creds.getUserName());
    ...
    protected void successfulAuthentication(
        ...
        UsersEntity user = _userRepository.findByUsername(userName);

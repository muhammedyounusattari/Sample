...
import com.sample.sample.domain.core.customer.*;
import com.sample.sample.domain.core.customer.CustomerEntity;
import com.sample.sample.domain.core.customer.QCustomerEntity;
import java.time.*;
...
public class CustomerAppServiceTest {
    ...
    public void updateCustomer_CustomerIdIsNotNullAndIdExists_ReturnUpdatedCustomer() {
        ...
        Optional<CustomerEntity> customerOptional = Optional.of((CustomerEntity) customerEntity);
        Mockito.when(_customerRepository.findById(anyLong())).thenReturn(customerOptional);
